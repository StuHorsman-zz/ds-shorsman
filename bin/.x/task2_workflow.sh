...
#===============================================================================
../client/bin/ml kassign --input-paths ds-shorsman/outgoing/task2 --format avro --centers-file ../data/task2_centers.avro --center-ids 15 --output-path ds-shorsman/outgoing/task2/assigned --output-type csv
