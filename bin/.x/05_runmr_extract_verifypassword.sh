...
hadoop fs -rm -r -skipTrash ds-shorsman/outgoing/type/verifypassword

# Run job02
echo "Running job mapreduce 05: Extracting verifypassword types..."
...
-output ds-shorsman/outgoing/type/verifypassword \
-mapper ../lib/map_extract_verifypassword.py \
-reducer ../lib/reduce_type.py \
-file ../lib/map_extract_verifypassword.py \
