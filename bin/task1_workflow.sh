...
# parental controls.  This setting indicates whether a user account switched
...
#
# The Task1Solution.R is derived from the Task1Analysis.R which was used
# for testing.  This can be found in the src/main/R/task1 folder.
# 
#===============================================================================
...
echo "Dowloading the known kids users from parental_control..."
hadoop fs -cat /user/hive/warehouse/movies.db/parental_controls/* | awk '{print $4}' > ../data/task1_kid_users.csv
