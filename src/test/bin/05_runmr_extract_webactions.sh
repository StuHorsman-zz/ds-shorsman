...
hadoop fs -rm -r -skipTrash ds-shorsman/outgoing/type/webactions

# Run job05
echo "Running job mapreduce 05: Extracting webactions types..."
...
-output ds-shorsman/outgoing/type/webactions \
-mapper ../lib/map_extract_webactions.py \
-reducer ../lib/reduce_type.py \
-file ../lib/map_extract_webactions.py \
