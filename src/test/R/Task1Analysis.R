...
cvglm.model.a <- cv.glmnet(x=train.predictors, y=train.targets, family="binomial")
plot(cvglm.model.a)
...
cvglm.model.all.d <- cv.glmnet(x=all.predictors, y=all.targets, 
                               family="binomial", type.measure="deviance")
plot(cvglm.model.all.d)
...
# Plot the response
all.predict.resp <- predict(glm.model.all, all.predictors, type="response")
...
validate.predict.resp <- predict(glm.model.all, validate.predictors, type="response")
